...
const PRODUCTS = [
  // Trang 1
  { id: 1, name: "Figure Tanjiro", anime: "Demon Slayer", price: 329000, img: "https://placehold.co/300x170/2f9bf3/FFF?text=Tanjiro", desc: "Figure Tanjiro chi tiết cao 15cm, chất liệu PVC.", size: "15cm" },
  { id: 2, name: "Figure Nezuko", anime: "Demon Slayer", price: 349000, img: "https://placehold.co/300x170/2f9bf3/FFF?text=Nezuko", desc: "Nezuko phiên bản chi tiết, có chân đế.", size: "15cm" },
  { id: 3, name: "Figure Zenitsu", anime: "Demon Slayer", price: 319000, img: "https://placehold.co/300x170/2f9bf3/FFF?text=Zenitsu", desc: "Figure Zenitsu mẫu demo.", size: "16cm" },
  { id: 4, name: "Figure Naruto", anime: "Naruto", price: 329000, img: "images/NARUTO/Naruto.png", desc: "Naruto với Rasengan.", size: "18cm" },
  { id: 5, name: "Figure Sasuke", anime: "Naruto", price: 359000, img: "images/NARUTO/Sasuke.png", desc: "Sasuke pó chiến đấu.", size: "18cm" },
  { id: 6, name: "Figure Kakashi", anime: "Naruto", price: 299000, img: "images/NARUTO/Kakashi.png", desc: "Kakashi mẫu demo.", size: "17cm" },
  { id: 7, name: "Figure Miku", anime: "Hatsune Miku", price: 329000, img: "https://placehold.co/300x170/3498db/FFF?text=Miku", desc: "Miku phiên bản sân khấu.", size: "14cm" },
  { id: 8, name: "Figure Luka", anime: "Hatsune Miku", price: 319000, img: "https://placehold.co/300x170/3498db/FFF?text=Luka", desc: "Luka mẫu demo.", size: "14cm" },
  { id: 9, name: "Figure Genshin A", anime: "Genshin Impact", price: 329000, img: "https://placehold.co/300x170/9b59b6/FFF?text=Genshin", desc: "Nhân vật Genshin mẫu A.", size: "12cm" },

  // Trang 2
  { id: 10, name: "Figure Genshin B", anime: "Genshin Impact", price: 349000, img: "https://placehold.co/300x170/9b59b6/FFF?text=Genshin", desc: "Nhân vật Genshin mẫu B.", size: "13cm" },
  { id: 11, name: "Figure Zhongli", anime: "Genshin Impact", price: 379000, img: "https://placehold.co/300x170/9b59b6/FFF?text=Zhongli", desc: "Zhongli thần nham.", size: "20cm" },
  { id: 12, name: "Figure Ayaka", anime: "Genshin Impact", price: 369000, img: "https://placehold.co/300x170/9b59b6/FFF?text=Ayaka", desc: "Ayaka thanh lịch.", size: "15cm" },
  { id: 13, name: "Figure Itachi", anime: "Naruto", price: 389000, img: "https://placehold.co/300x170/f39c12/FFF?text=Itachi", desc: "Itachi phiên bản giới hạn.", size: "18cm" },
  { id: 14, name: "Figure Rock Lee", anime: "Naruto", price: 269000, img: "https://placehold.co/300x170/f39c12/FFF?text=Rock+Lee", desc: "Rock Lee năng động.", size: "16cm" },
  { id: 15, name: "Figure Tanjirou2", anime: "Demon Slayer", price: 339000, img: "https://placehold.co/300x170/2f9bf3/FFF?text=Tanjiro+2", desc: "Tanjiro phiên bản 2.", size: "15cm" },
];
...
function renderTopics() {
  const CATS = ["Tất cả", "Demon Slayer", "Genshin Impact", "Hatsune Miku", "Naruto"];
  topicsEl.innerHTML = CATS.map(c => `<button class="topic-btn" data-cat="${c}">${c}</button>`).join('');
...
function renderProducts() {
  ...
  gridEl.innerHTML = itemsOnPage.map(p => `
  ...
  document.querySelectorAll('.card').forEach(card => {
    ...
    card.addEventListener('keydown', e => { if (e.key === 'Enter') showDetail(+card.dataset.id); });
  });
...
function initializeHeroSlider() {
  ...
  function updateHero() {
    ...
    if (heroDots) {
      heroDots.innerHTML = HERO_TEXTS.map((_, i) => 
        `<button class="${i === heroIndex ? 'active' : ''}" data-i="${i}"></button>`
      ).join('');
      heroDots.querySelectorAll('button').forEach(b => b.addEventListener('click', () => {
...
function initializeSearch() {
  searchInput?.addEventListener('input', () => {
    ...
    const searchResults = PRODUCTS.filter(p => 
      p.name.toLowerCase().includes(query) || p.anime.toLowerCase().includes(query)
    );
...
function initializeApp() {
  ...
  document.querySelector('.topic-btn[data-cat="Tất cả"]').classList.add('active');
}
